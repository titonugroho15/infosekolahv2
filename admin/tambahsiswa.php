  		...
  		<div class="col-lg-10" style=" margin-top:55px;">
  			...
  			<div class="panel panel-default">
 				<div class="panel-body">
 					<h2><span class="glyphicon glyphicon-user"></span> Tambah Data Siswa</h2>
 					<hr>
 						<div class="col-lg-8">
    					<form role="form" action="ceksiswa.php" method="post" enctype="multipart/form-data"">
    						<div class="col-lg-3">
							  <div class="form-group">
							    <label for=""></label>
							    <input type="text" class="form-control" id="" placeholder="Masukan Nomor NIS" name="nis" required/>
							  </div>
							 </div>
							 <div class="col-lg-5">
							  <div class="form-group">
							    <label for=""> </label>
							    <input type="text" class="form-control" id="" placeholder="Nama Lengkap" name="nama_siswa" required/>
							  </div>
							 </div>
							  <div class="col-lg-5">
							  	<br>
