...
<head>
	...
	<script type="text/javascript">
		function edt_id(id)
		{
		 ...
		 {
		  window.location.href='editsiswa.php?edit_id='+id;
		 }
		}
		function delete_id(id)
		{
		 ...
		 {
		  window.location.href='dsiswa.php?delete_id='+id;
		 }
		}
	</script>
</head>
<body style="font-family: fira sans;background-color: #cecdcc;">
			   ...
			   <div class="form-group">
			    <div class="col-lg-3">
			     <a href="tambahsiswa.php" class="btn btn-primary" >
			     				<span class="glyphicon glyphicon-plus"></span> Tambah Siswa</a>
			    </div>
			  </div>
			 </form>
  			<div class="panel panel-default">
				  <!-- Default panel contents -->
				  <div class="panel-heading"><span class="glyphicon glyphicon-user"></span> Data Siswa</div>
    ...
    if($cur_page > 1)
    {
        echo "<a href='dsiswa.php?page=" . ($cur_page - 1) . "'>Prev</a>&nbsp;&nbsp;&nbsp;";
    }
    else
    {
        echo "";
    ...
    {
        echo "<a href='dsiswa.php?page=" . ($cur_page + 1) . "'>Next</a>";
    }
    else
	{
		echo "";
