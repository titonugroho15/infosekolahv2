...
<head>
	...
	<script type="text/javascript">
		function edt_id(id)
		{
		 ...
		 {
		  window.location.href='editeskul.php?edit_id='+id;
		 }
		}
		function delete_id(id)
		{
		 ...
		 {
		  window.location.href='deskul.php?delete_id='+id;
		 }
		}
	</script>
</head>
<body style="font-family: fira sans;background-color: #cecdcc;">
	...
	<?php include "include/menu.php"; ?>
  		<div class="col-lg-10" style=" margin-top:55px;">
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    <div class="col-lg-3">
			      <a href="openlink.php?p=inputeskul" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah Data Ekstrakulikuler</a>
			    </div>
			  </div>
			 </form>
  			<div class="panel panel-default">
				  <!-- Default panel contents -->
				  <div class="panel-heading"><span class="glyphicon glyphicon-user"></span> Data Ekstrakulikuler</div>
					  <div class="panel-body">
					  	 ...
					  	 include "../dbconfig.php";
								...
								$sql = mysql_query("SELECT * FROM ekskul LIMIT $per_page OFFSET $offset")
						?>
    ...
    if($cur_page > 1)
    {
        echo "<a href='deskul.php?page=" . ($cur_page - 1) . "'>Prev</a>&nbsp;&nbsp;&nbsp;";
    }
    else
    {
        echo "";
    ...
    {
        echo "<a href='deskul.php?page=" . ($cur_page + 1) . "'>Next</a>";
    }
    else
	{
		echo "";
