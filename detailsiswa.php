...
<div style="padding-top: 60px;"></div>
	<div class="container" style="background-color: #ffffff; ">
    	<div class="row">
            ...
            <?php                  
                        $query = mysql_query( "SELECT * FROM tbsiswa WHERE nis='".$_GET['kd']."'") or die(mysql_error());
            ...
            <div class="col-sm-5" style="padding-left:70px;">
                    ...
                    <div class="title"><h1><b><?php echo $data['nama']; ?></b></h1></div>
                    <div class=""><h4><b><?php echo $data['nis']; ?></b></h4></div>
                    ...
                    <div><h4>Kelas :<?php echo $data['kelas']; ?></h4></div>
                     <div><h4>Status :<?php echo $data['status']; ?></h4></div>
                    <hr>
                    <div style="float:left; padding-right:10px;"><h3><?php echo $data['alamat']; ?></h3><br>

                    <!--<a href="cart.php?act=add&amp;barang_id=<?php echo $data['id_produk']; ?>&amp;ref=vi_cart.php?kd=<?php echo $data['id_produk'];?>" class="btn btn-lg btn-danger">Beli &raquo;</a></div>-->
                   <a href="datasiswa.php" class="btn btn-lg btn-default">Kembali</a></div>
